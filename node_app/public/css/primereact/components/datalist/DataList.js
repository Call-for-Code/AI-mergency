...
var DataList = exports.DataList = function (_Component) {
    ...
    _createClass(DataList, [{
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('ui-datalist ui-widget', this.props.className);
            ...
            var header = this.props.header && _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    value && value.map(function (val, i) {
                        var listItemContent = _this2.props.itemTemplate ? _this2.props.itemTemplate(val) : val;
            ...
            return _react2.default.createElement(
                ...
                { id: this.props.id, ref: function ref(el) {
                        return _this2.dataListEl = _reactDom2.default.findDOMNode(el);
