...
var MenubarSub = function (_Component) {
    ...
    _createClass(MenubarSub, [{
        ...
        value: function renderSubmenuIcon(item) {
            var icon = (0, _classnames2.default)('ui-submenu-icon pi pi-fw', { 'pi-caret-down': this.props.root, 'pi-caret-right': !this.props.root });
        ...
        value: function render() {
            var className = (0, _classnames2.default)({ 'ui-widget-content ui-corner-all ui-submenu-list ui-shadow': !this.props.root, 'ui-menubar-root-list': this.props.root });
...
var Menubar = exports.Menubar = function (_Component2) {
    ...
    _createClass(Menubar, [{
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('ui-menubar ui-widget ui-widget-content ui-corner-all', this.props.className);
