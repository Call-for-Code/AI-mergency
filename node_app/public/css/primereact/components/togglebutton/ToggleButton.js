...
var ToggleButton = exports.ToggleButton = function (_Component) {
    ...
    _createClass(ToggleButton, [{
        ...
        value: function render() {
            var className = (0, _classnames2.default)('ui-button ui-togglebutton ui-widget ui-state-default ui-corner-all', this.props.className, {
            ...
            if (this.props.onIcon || this.props.offIcon) {
                iconStyleClass = (0, _classnames2.default)('ui-c', this.props.checked ? this.props.onIcon : this.props.offIcon, {
